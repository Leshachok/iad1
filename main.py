...
firstclass = MyClass(ac.AverageClass(x1).Average, ac.AverageClass(y1).Average, '$\clubsuit$', 'green')
...
secondclass = MyClass(ac.AverageClass(x2).Average, ac.AverageClass(y2).Average, '$F$', '#46351D')
...
thirdclass = MyClass(ac.AverageClass(x3).Average, ac.AverageClass(y3).Average, '*', 'r')
...
fourthclass = MyClass(ac.AverageClass(x4).Average, ac.AverageClass(y4).Average, '1', 'b')
